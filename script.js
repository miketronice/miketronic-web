...
.content-gallery{position:relative;width:100%;aspect-ratio:16/9;overflow:hidden;background:#05090d}
.content-gallery-slide{position:absolute;inset:0;opacity:0;transition:opacity .55s ease}
.content-gallery-slide.active{opacity:1;z-index:1}
.content-gallery-slide img{width:100%;height:100%;display:block;object-fit:cover}
.content-gallery:after{content:"";position:absolute;inset:0;z-index:2;pointer-events:none;background:linear-gradient(to top,rgba(3,8,12,.34),transparent 42%)}
.content-gallery-arrow{position:absolute;z-index:4;top:50%;transform:translateY(-50%);width:34px;height:34px;border-radius:50%;border:1px solid rgba(255,255,255,.18);background:rgba(4,12,18,.68);backdrop-filter:blur(6px);color:#eaf8ff;display:grid;place-items:center;cursor:pointer;transition:.2s}
.content-gallery-arrow:hover{border-color:#5cc8ff;background:rgba(24,168,255,.18)}
.content-gallery-prev{left:10px}.content-gallery-next{right:10px}
.content-gallery-dots{position:absolute;z-index:4;left:50%;bottom:10px;transform:translateX(-50%);display:flex;gap:6px}
.content-gallery-dot{width:6px;height:6px;padding:0;border:0;border-radius:50%;background:rgba(255,255,255,.42);cursor:pointer;transition:.2s}
.content-gallery-dot.active{width:18px;border-radius:8px;background:#5cc8ff;box-shadow:0 0 9px rgba(24,168,255,.7)}
.gallery-more{min-height:44px;border:1px solid rgba(92,200,255,.20);background:rgba(24,168,255,.035);border-radius:12px;display:inline-flex;align-items:center;gap:10px;padding:0 16px;margin-top:8px;color:#eef5f9;font-size:.86rem;font-weight:700}.gallery-more i{color:#5cc8ff}
...
const setupHeroDiagnosticAnimation = () => {
  ...
  style.textContent = `
  .diag-demo{position:relative;min-height:430px;height:100%;overflow:hidden;background:radial-gradient(circle at 50% 39%,rgba(24,168,255,.13),transparent 37%),linear-gradient(155deg,#091720,#050c12 72%);font-family:Inter,system-ui,sans-serif}.diag-demo:before{content:"";position:absolute;inset:0;opacity:.15;background-image:linear-gradient(rgba(92,200,255,.12) 1px,transparent 1px),linear-gradient(90deg,rgba(92,200,255,.12) 1px,transparent 1px);background-size:30px 30px;mask-image:linear-gradient(to bottom,transparent,#000 17%,#000 82%,transparent)}.diag-head{position:absolute;left:22px;right:22px;top:18px;display:flex;justify-content:space-between;align-items:center;color:#6f91a4;font-size:.58rem;letter-spacing:.14em;z-index:5}.diag-head strong{color:#8bdcff;font-size:.62rem}.diag-live{display:flex;align-items:center;gap:7px}.diag-live:before{content:"";width:6px;height:6px;border-radius:50%;background:#5cc8ff;box-shadow:0 0 10px #18a8ff;animation:diagBlink 1.2s ease-in-out infinite}.diag-scene{position:absolute;left:5%;right:5%;top:18%;height:188px;display:grid;grid-template-columns:142px 72px 1fr 118px;align-items:center;gap:8px;z-index:2}.pc-unit{justify-self:center;width:132px;height:112px;position:relative}.pc-screen{position:absolute;left:8px;right:8px;top:0;height:76px;border:2px solid #5d8093;border-radius:7px;background:#06131b;box-shadow:0 0 20px rgba(24,168,255,.18),inset 0 0 18px rgba(24,168,255,.04);overflow:hidden}.pc-screen:after{content:"";position:absolute;left:50%;bottom:-16px;width:5px;height:16px;background:#58798a;transform:translateX(-50%)}.pc-base{position:absolute;left:32px;right:32px;bottom:15px;height:5px;border-radius:5px;background:#58798a}.pc-base:after{content:"";position:absolute;left:-18px;right:-18px;top:5px;height:4px;border-radius:5px;background:#3a5665}.screen-ui{position:absolute;inset:7px;display:flex;flex-direction:column;gap:6px}.screen-title{font:700 .54rem 'Space Grotesk';letter-spacing:.1em;color:#dff5ff}.screen-progress{height:5px;border-radius:10px;background:rgba(255,255,255,.08);overflow:hidden}.screen-progress span{display:block;height:100%;width:0;background:linear-gradient(90deg,#157dff,#5cc8ff);box-shadow:0 0 8px #18a8ff;transition:width .05s linear}.screen-log{display:grid;gap:4px}.screen-log i{display:block;height:2px;border-radius:4px;background:#2c5e78;opacity:.78}.screen-log i:nth-child(2){width:78%;background:#5cc8ff}.screen-log i:nth-child(3){width:62%}.screen-log i:nth-child(4){width:86%;background:#367ca3}.diag-demo.is-communicating .screen-log{animation:screenTraffic .8s steps(2,end) infinite}.vci{justify-self:center;width:62px;height:44px;border:1px solid rgba(92,200,255,.44);border-radius:10px;background:linear-gradient(155deg,#112430,#08131b);box-shadow:0 0 20px rgba(24,168,255,.14),inset 0 0 14px rgba(24,168,255,.05);position:relative;display:flex;align-items:center;justify-content:center;font:700 .62rem 'Space Grotesk';letter-spacing:.12em;color:#dff5ff}.vci:before,.vci:after{content:"";position:absolute;top:50%;width:15px;height:2px;background:#5cc8ff;box-shadow:0 0 8px #18a8ff}.vci:before{right:100%}.vci:after{left:100%}.vci-led{position:absolute;right:8px;top:7px;width:5px;height:5px;border-radius:50%;background:#5cc8ff;box-shadow:0 0 9px #18a8ff;animation:diagBlink .8s ease-in-out infinite}.data-link{height:60px;position:relative}.data-wire{position:absolute;left:0;right:0;top:29px;height:2px;background:linear-gradient(90deg,rgba(92,200,255,.18),#5cc8ff 35%,#18a8ff 65%,rgba(92,200,255,.18));box-shadow:0 0 10px rgba(24,168,255,.28)}.data-wire:before,.data-wire:after{content:"";position:absolute;top:-3px;width:8px;height:8px;border-radius:50%;background:#5cc8ff;box-shadow:0 0 10px #18a8ff}.data-wire:before{left:-1px}.data-wire:after{right:-1px}.data-packet{position:absolute;top:25px;width:10px;height:10px;border-radius:3px;background:#8ee2ff;box-shadow:0 0 12px #18a8ff;opacity:0}.diag-demo.is-running .data-packet{animation:packetOut 1.05s linear infinite}.diag-demo.is-running .packet-2{animation-delay:.34s}.diag-demo.is-running .packet-3{animation-delay:.68s}.packet-back{display:none;background:#317cff}.diag-demo.is-communicating .packet-back{display:block;animation:packetBack 1.2s linear infinite;animation-delay:.2s}.vehicle{justify-self:center;text-align:center;color:#d8f3ff;position:relative}.vehicle i{font-size:4.3rem;color:#cdefff;filter:drop-shadow(0 0 16px rgba(24,168,255,.28));transition:filter .3s ease}.diag-demo.is-communicating .vehicle i{filter:drop-shadow(0 0 23px rgba(24,168,255,.5))}.vehicle span{display:block;margin-top:5px;color:#6c94aa;font-size:.54rem;letter-spacing:.14em;font-weight:700}.diag-panel{position:absolute;left:9%;right:9%;bottom:30px;padding:16px 18px 14px;border:1px solid rgba(92,200,255,.19);border-radius:15px;background:rgba(5,13,19,.78);backdrop-filter:blur(10px);z-index:4;box-shadow:0 12px 34px rgba(0,0,0,.22)}.diag-phase-row{display:flex;justify-content:space-between;align-items:flex-end;gap:16px}.diag-phase-label{color:#6c91a6;font-size:.55rem;letter-spacing:.16em;margin-bottom:3px}.diag-phase{font:700 1.03rem 'Space Grotesk';letter-spacing:.08em;color:#dff5ff;text-transform:uppercase}.diag-counter{font:700 1.45rem 'Space Grotesk';color:#5cc8ff;min-width:74px;text-align:right;text-shadow:0 0 14px rgba(24,168,255,.35)}.diag-progress{height:5px;border-radius:99px;margin-top:12px;background:rgba(255,255,255,.07);overflow:hidden}.diag-progress span{display:block;width:0;height:100%;border-radius:inherit;background:linear-gradient(90deg,#157dff,#5cc8ff);box-shadow:0 0 12px rgba(24,168,255,.55);transition:width .05s linear}.diag-demo.is-communicating .diag-progress span{width:100%!important;animation:commPulse 1.35s ease-in-out infinite}.diag-substatus{display:flex;justify-content:space-between;gap:10px;margin-top:9px;color:#54798f;font-size:.48rem;letter-spacing:.13em}.diag-substatus .active{color:#7dd9ff}@keyframes packetOut{0%{left:0;opacity:0;transform:scale(.7)}10%{opacity:1}90%{opacity:1}100%{left:calc(100% - 10px);opacity:0;transform:scale(1)}}@keyframes packetBack{0%{left:calc(100% - 10px);opacity:0}10%{opacity:.9}90%{opacity:.9}100%{left:0;opacity:0}}@keyframes commPulse{0%,100%{opacity:.45}50%{opacity:1}}@keyframes diagBlink{50%{opacity:.3;transform:scale(.75)}}@keyframes screenTraffic{0%{transform:translateY(0);opacity:.68}50%{transform:translateY(2px);opacity:1}100%{transform:translateY(0);opacity:.8}}@media(max-width:620px){.diag-demo{min-height:360px}.diag-scene{left:4%;right:4%;top:17%;height:150px;grid-template-columns:96px 48px 1fr 76px;gap:4px}.pc-unit{width:94px;height:92px}.pc-screen{left:4px;right:4px;height:58px}.pc-base{left:25px;right:25px;bottom:18px}.screen-ui{inset:5px;gap:4px}.screen-title{font-size:.42rem}.vci{width:44px;height:34px;font-size:.48rem}.vci:before,.vci:after{width:10px}.vehicle i{font-size:3rem}.vehicle span{font-size:.42rem}.diag-panel{left:6%;right:6%;bottom:20px;padding:14px}.diag-phase{font-size:.82rem}.diag-counter{font-size:1.15rem;min-width:62px}.diag-head{left:16px;right:16px;top:14px}.diag-substatus{font-size:.4rem}}@media(prefers-reduced-motion:reduce){.diag-live:before,.vci-led,.data-packet,.diag-progress span,.screen-log{animation:none!important}}`;
  document.head.appendChild(style);
  stage.innerHTML = `<div class="diag-demo is-running" aria-label="Ordenador conectado a una VCI de diagnosis y a un vehículo"><div class="diag-head"><strong>MIKETRONIC</strong><span class="diag-live">LINK ACTIVO</span></div><div class="diag-scene"><div class="pc-unit" aria-label="Ordenador de diagnosis"><div class="pc-screen"><div class="screen-ui"><div class="screen-title">CODIFICANDO</div><div class="screen-progress"><span></span></div><div class="screen-log"><i></i><i></i><i></i><i></i></div></div></div><div class="pc-base"></div></div><div class="vci" aria-label="VCI de diagnosis">VCI<span class="vci-led"></span></div><div class="data-link" aria-hidden="true"><div class="data-wire"></div><span class="data-packet packet-1"></span><span class="data-packet packet-2"></span><span class="data-packet packet-3"></span><span class="data-packet packet-back"></span></div><div class="vehicle"><i class="fa-solid fa-car-side"></i><span>VEHÍCULO</span></div></div><div class="diag-panel"><div class="diag-phase-row"><div><div class="diag-phase-label">PROCESO ACTUAL</div><div class="diag-phase">DIAGNOSTICANDO</div></div><div class="diag-counter">0%</div></div><div class="diag-progress"><span></span></div><div class="diag-substatus"><span class="active">CAN / UDS ONLINE</span><span>TX ↔ RX</span><span>12.4 V</span></div></div></div>`;
  const demo=stage.querySelector('.diag-demo'),phaseEl=stage.querySelector('.diag-phase'),counterEl=stage.querySelector('.diag-counter'),progressEl=stage.querySelector('.diag-progress span'),screenTitle=stage.querySelector('.screen-title'),screenProgress=stage.querySelector('.screen-progress span');
  if (!demo || !phaseEl || !counterEl || !progressEl || !screenTitle || !screenProgress) return;
  if (window.matchMedia('(prefers-reduced-motion: reduce)').matches) {phaseEl.textContent='COMUNICANDO';counterEl.textContent='ONLINE';progressEl.style.width='100%';screenTitle.textContent='ONLINE';screenProgress.style.width='100%';demo.classList.add('is-communicating');return;}
  const phases=[{label:'DIAGNOSTICANDO',duration:1900},{label:'CODIFICANDO',duration:1750},{label:'PROGRAMANDO',duration:2100}];
  const runPhase=({label,duration})=>new Promise(resolve=>{phaseEl.textContent=label;screenTitle.textContent=label;let start=0;const tick=t=>{if(!start)start=t;const ratio=Math.min((t-start)/duration,1),eased=1-Math.pow(1-ratio,2.2),value=Math.min(100,Math.round(eased*100));counterEl.textContent=`${value}%`;progressEl.style.width=`${value}%`;screenProgress.style.width=`${value}%`;if(ratio<1)requestAnimationFrame(tick);else setTimeout(resolve,260)};requestAnimationFrame(tick)});
  (async()=>{for(const phase of phases){progressEl.style.width='0%';screenProgress.style.width='0%';counterEl.textContent='0%';await runPhase(phase)}phaseEl.textContent='COMUNICANDO';counterEl.textContent='ONLINE';progressEl.style.width='100%';screenTitle.textContent='COMUNICANDO';screenProgress.style.width='100%';demo.classList.add('is-communicating')})();
};
...
if(contentGrid&&Array.isArray(window.MIKETRONIC_CONTENT)){
  const getYouTubeId=(url='')=>{const match=url.match(/(?:youtu\.be\/|youtube\.com\/(?:watch\?v=|embed\/|shorts\/))([^?&/]+)/i);return match?match[1]:''};
  const escapeHtml=(value='')=>String(value).replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;').replace(/"/g,'&quot;').replace(/'/g,'&#039;');
  contentGrid.innerHTML=window.MIKETRONIC_CONTENT.slice(0,3).map((item,index)=>{
    const delay=index===1?' delay-1':index===2?' delay-2':'',tag=escapeHtml(item.tag||'CONTENIDO'),url=escapeHtml(item.url||'#');
    if(item.type==='gallery'){
      const title=escapeHtml(item.title||'Trabajos y proyectos'),description=escapeHtml(item.description||''),images=Array.isArray(item.images)?item.images.filter(Boolean):[];
      const slides=images.length?images.map((src,i)=>`<div class="content-gallery-slide${i===0?' active':''}"><img src="${escapeHtml(src)}" alt="${title} - foto ${i+1}" loading="lazy"></div>`).join(''):`<div class="content-gallery-slide active" style="display:grid;place-items:center;color:#547184">AÑADE FOTOS</div>`;
      const dots=images.length>1?images.map((_,i)=>`<button class="content-gallery-dot${i===0?' active':''}" type="button" aria-label="Ver foto ${i+1}"></button>`).join(''):'';
      const controls=images.length>1?`<button class="content-gallery-arrow content-gallery-prev" type="button" aria-label="Foto anterior"><i class="fa-solid fa-chevron-left"></i></button><button class="content-gallery-arrow content-gallery-next" type="button" aria-label="Foto siguiente"><i class="fa-solid fa-chevron-right"></i></button><div class="content-gallery-dots">${dots}</div>`:'';
      return `<article class="content-card reveal${delay} gallery-card"><div class="content-gallery">${slides}${controls}</div><div class="youtube-card-body"><span class="content-tag">${tag}</span><h3>${title}</h3>${description?`<p>${description}</p>`:''}<span class="gallery-more"><i class="fa-regular fa-images"></i> Galería Miketronic</span></div></article>`;
    }
  ...
  document.querySelectorAll('.content-gallery').forEach(gallery=>{
    const slides=[...gallery.querySelectorAll('.content-gallery-slide')],dots=[...gallery.querySelectorAll('.content-gallery-dot')],prev=gallery.querySelector('.content-gallery-prev'),next=gallery.querySelector('.content-gallery-next');
    ...
    const start=()=>{clearInterval(timer);timer=setInterval(()=>show(current+1),4500)};
    prev?.addEventListener('click',()=>{show(current-1);start()});next?.addEventListener('click',()=>{show(current+1);start()});dots.forEach((dot,i)=>dot.addEventListener('click',()=>{show(i);start()}));start();
  });
}
